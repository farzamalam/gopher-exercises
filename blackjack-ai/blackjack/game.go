...
// Score will take in a hand of cards and return the best blackjact
...
// Soft returns true if the score of hand is a soft score- that is
// if an ace is being counted as 11 points.
